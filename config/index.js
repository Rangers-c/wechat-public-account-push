export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx8a4514e40a22b2df",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "8fd0be815c8aa3ea7909e2892063a1bb",
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "nGb0dTPdLREyg9Z7Xl5ysrXOzhvXWEjXXd_mMznsNcU",
      // 所在省份
      province: "甘肃",
      // 所在城市
      city: "兰州",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "公主生日", "year": "2003", "date": "09-08"},
        {"type": "节日", "name": "元旦", "year": "2000", "date": "01-01"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "小王生日", "year": "2000", "date": "09-19"},
